...
namespace Basketball_Manager_Db.Migrations
{
    ...
    [Migration("20211127122416_changedRelationshipBetweenPlayerAndPlayerInfo")]
    partial class changedRelationshipBetweenPlayerAndPlayerInfo
    {
            ...
            modelBuilder.Entity("NBA_Manager_Api.Models.PlayerInfoModel", b =>
                {
                    b.HasOne("NBA_Manager_Api.Models.PlayerModel", "Player")
                        .WithOne("PlayerInfo")
                        .HasForeignKey("NBA_Manager_Api.Models.PlayerInfoModel", "PlayerId")
